    ...
    <>
      ...
      {isLoading ? (
        ...
        <main className="mx-auto my-0 max-w-screen-lg p-8 text-white_accent">
          <div className="mb-8  rounded-sm bg-secondary p-4 ">
            <div className="text-center font-merriweather text-4xl font-bold">
              CHECKOUT
            </div>
            <div className="mt-8 flex w-full items-center justify-center gap-8">
              ...
              <div className="flex max-w-[50%] flex-col">
                ...
                <div className="min-w-96 font-merriweather text-2xl">
